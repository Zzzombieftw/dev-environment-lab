...
- Graph:
  - Customize the color and display text of vertices through VS Code [settings](https://github.com/microsoft/vscode-cosmosdb/blob/main/README.md#graphSettings)
